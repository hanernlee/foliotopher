          ...
          <div style={[styles.contactSection, styles.backgroundImage]}>
            <div style={styles.infoContainer}>
              <div style={styles.infoDescription}>
                ...
                <div className="showContact showParaFour" style={styles.infoPara}>New experiences and challenges are things I constantly look forward to. <span style={styles.bold}>Feel free to get in touch!</span></div>
              </div>
